...
const phoneStart = { url: phoneStartUrl };
const phoneTimer = { url: phoneTimerUrl };
const phoneNames = { url: phoneNamesUrl };
const phoneAd = { url: phoneAdUrl };
const phoneMedia = { url: phoneMediaUrl };
const phoneFT = { url: phoneFTUrl };
